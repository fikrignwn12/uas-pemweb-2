                ...
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div>
                            ...
                            <h3 class="display-6 fw-bold text-success mb-0">Rp348.000.000</h3>
                        </div>
                ...
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div>
                            ...
                            <h3 class="display-6 fw-bold text-primary mb-0">145</h3>
                        </div>
                    ...
                    <div class="mt-3 text-primary">
                        <i class="fas fa-arrow-up me-1"></i>
                        <small>23 transaksi hari ini</small>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="list-group-item py-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <small class="text-muted">Polytron Smart TV 4k - Rp13.000.000</small>
                        </div>
                ...
                <div class="list-group-item py-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <small class="text-muted">Samsung Neo QLED TV - Rp18.000.000</small>
                        </div>
